...
\lstinputlisting[style=cppstyle]{./src/5 数论/MillerRabin.cpp}
\subsection{PollardRho}
\lstinputlisting[style=cppstyle]{./src/5 数论/PollardRho.cpp}
\subsection{区间筛}
\lstinputlisting[style=cppstyle]{./src/5 数论/区间筛.cpp}
\subsection{欧拉筛}
