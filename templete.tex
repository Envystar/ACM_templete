...
\subsection{树状数组2}
\input{./src/3 数据结构/树状数组2.tex}
\lstinputlisting[style=cppstyle]{./src/3 数据结构/树状数组2.cpp}
\subsection{波纹疾走树}
...
\subsection{线段树优化建图}
\input{./src/3 数据结构/线段树优化建图.tex}
\lstinputlisting[style=cppstyle]{./src/3 数据结构/线段树优化建图.cpp}
\subsection{重链剖分}
